...
$KM_PAGE = [
    ...
    'titleKey' => 'page.e500.title',
    'title' => '500 サーバーエラー | KosenMap 管理',
];
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-8 col-lg-6 text-center">
            ...
            <h1 class="h3 mb-3" data-i18n="page.e500.heading">サーバーでエラーが発生しました</h1>
            <p class="text-secondary mb-4" data-i18n="page.e500.text">
              処理を完了できませんでした。しばらく待って再度お試しください。続く場合はサーバーのログを確認してください。
            </p>
